...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across BCA enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific BCA decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search BCA merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "List all sectors with BCA enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "be_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "BCA (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "BCA (https://www.bundeskartellamt.de/)",
